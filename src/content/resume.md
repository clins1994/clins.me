...
### 🎶 Software Engineer ▪ [Soundraw Inc.](https://soundraw.io)

🇯🇵 Tokyo, Japan (Hybrid) ▪ Jan 2025 ~ Present
...
🛠️ Cloudflare, Domain modeling, FFmpeg, Linear, Ruby on Rails, Vue, Heroku, Postgres, MongoDB, AI Agents

### 💼 Software Engineer ▪ [Kadric Smart Solutions](https://www.ksmartsolutions.jp)

🇯🇵 Tokyo, Japan (Hybrid) ▪ May 2023 ~ Nov 2025
...
🛠️ Consulting, React, TypeScript, Node.js, Vue, Java, Spring, MUI, deck.gl, AWS, Terraform, Japanese, Docker, Atlassian
...
🛠️ Web and API scraping, API integration, Node.js, TypeScript, AWS, Ruby on Rails, SQL, Redash, Sumo Logic, Atlassian, Slack

### 🗣️ Software Engineer ▪ [Verball](https://www.verball.co)
...
🛠️ Node.js, JavaScript, Google Cloud Platform (GCP), MySQL, Firebase, Actions on Google, Google Assistant
...
🛠️ Microsoft Power BI, DAX, SQL, Python, Microsoft Office

### 🔓 Software Engineer ▪ [MuchMore Digital](https://muchmore.digital)
...
🛠️ SQL, GCP, BigQuery, Node.js, JavaScript, PHP, Python, Linux, Git, Cron jobs, Java, MongoDB, Play Framework, AngularJS, Google Maps API, Heroku, IBM Watson, GTM, Zendesk Java Client, Twitter API
...
- Mobile augmented reality researcher with scholarship at Voxar Labs (2 years).
